...
.cls_14{fill: var(--build-color-marcadores-pequenos);stroke-width: .3px;stroke: var(--build-color-black);}
.cls_17{fill: var(--build-color-baseMapa);stroke-width: .3px;stroke: var(--build-color-black);}
.cls_19{opacity: 1;}
